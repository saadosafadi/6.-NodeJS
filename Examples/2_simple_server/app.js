...
app.get('/saado', function(req, res) { //Create a new route '/arik' and execute this code when someone goes to /arik
    res.json({ //res.json simply returns whatever json is passed to it. We return a simple object with basic info and social networks
    	basicInfo: {
    		firstName:'saado', lastName: 'safadi', title:'Fullstack developer'
    	},
    	socialNetworks: [
	        {
	            name: 'Facebook',
